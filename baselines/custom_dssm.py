...
class CustomDSSM(ContextRecommender):
    ...
    def __init__(self, config, dataset):
        super(CustomDSSM, self).__init__(config, dataset)
        ...
        print(
            f"""\n
            Item float features: {self.item_float_field_num} \n
            User float features: {self.user_float_field_num} \n
            Item token_seq_field features: {self.item_token_seq_field_num} \n
            User token_seq_field features: {self.user_token_seq_field_num} \n
            User token_field_num features: { self.user_token_field_num} \n
            Item token_field_num features:  {self.item_token_field_num} \n
...
# class CustomDSSM(GeneralRecommender):
...
#         scores = torch.matmul(
#             user_e, all_item_e.transpose(0, 1)
#         )  # [batch_size, n_items]
